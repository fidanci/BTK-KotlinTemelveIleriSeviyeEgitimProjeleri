...
import com.fidansoft.besinlerkitabi.databinding.BesinRecyclerRowBinding
...
class BesinRecyclerAdapter(val besinListesi : ArrayList<Besin>) : RecyclerView.Adapter<BesinRecyclerAdapter.BesinViewHolder>(), BesinClickListener {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BesinViewHolder {
       ...
       // val itemView = inflater.inflate(R.layout.besin_recycler_row, parent,false)
        val itemView = DataBindingUtil.inflate<BesinRecyclerRowBinding>(inflater,R.layout.besin_recycler_row, parent,false)
