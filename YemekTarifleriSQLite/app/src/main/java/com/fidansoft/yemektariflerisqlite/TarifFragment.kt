            ...
            if (gelenBilgi.equals("menudengeldim")) {
                ...
                context?.let {
                    try {
                        ...
                        val db = it.openOrCreateDatabase("Yemekler", MODE_PRIVATE, null)
                        ...
                        while (cursor.moveToNext()){
                            ...
                            val bitmapFactory = BitmapFactory.decodeByteArray(byteDizisi,0, byteDizisi.size)
